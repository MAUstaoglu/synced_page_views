...
class SyncedPageController extends ChangeNotifier {
  ...
  void _primaryListener() {
    if (_isDisposed || !_primaryController.hasClients || !_secondaryController.hasClients) {
      return;
    }
    ...
    final clampedOffsetPrimary = _primaryController.offset.clamp(0.0, maxPrimary);
  ...
  void _secondaryListener() {
    ...
    final clampedOffsetSecondary = _secondaryController.offset.clamp(0.0, maxSecondary);
  ...
  Future<void> animateToPage(
    ...
    await Future.wait([
      ...
      _secondaryController.animateToPage(page, duration: duration, curve: curve),
    ]);
  }
