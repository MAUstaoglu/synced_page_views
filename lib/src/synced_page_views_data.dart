...
class SyncedPageViewsConfig {
  ...
  /// Whether to enable page snapping on the currently scrolling PageView.
  /// When true, only the PageView that is being actively scrolled will have
  /// snapping enabled to avoid conflicts between the two synchronized views.
...
class SyncedPageViewsData {
  ...
  void jumpToPage(int page) {
    primaryController.animateToPage(page,
        duration: Duration.zero, curve: Curves.linear);
    secondaryController.animateToPage(page,
        duration: Duration.zero, curve: Curves.linear);
  }
